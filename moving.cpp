...
{
    const int nImageHalfSize = nImageSize/5;
    const int nAxisSize = nImageSize/10;
...
{
    Vec2i imageHalfSize = Vec2i(display.cols/5, display.rows/5);
